...
| Forward paper trades recorded | **2,744** |
| Evaluated strategies that are net positive | **14 of 31** |
| **Average net result across all evaluated** | **-15.0%** |
<!-- /LIVE:record -->
...
*40,494 scored forecasts over 180 days. Headline hit rate: 52.5%.*
<!-- /LIVE:calibration -->
...
<!-- LIVE:market -->
**317 live markets** · **$16.5B** open interest · **10,119** quality-scored traders tracked of 20,368
<!-- /LIVE:market -->
...
*Live figures last refreshed: <!-- LIVE:stamp -->2026-09-19<!-- /LIVE:stamp --> (UTC).*
